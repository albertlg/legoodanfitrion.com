...
export function GuestBuilderView({
  ...
  return (
    ...
    <form className="bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl sm:border border-black/10 dark:border-white/10 sm:rounded-[2.5rem] sm:shadow-sm pb-8 sm:p-6 md:p-8 flex flex-col gap-6 w-full min-w-0 max-w-screen-xl px-4 sm:w-full sm:px-6 sm:mx-auto sm:my-6" onSubmit={handleSaveGuest} noValidate>
      ...
      <div className="sticky bottom-16 z-50 md:static md:z-auto md:mt-8 -mx-4 md:mx-0 px-4 md:px-0 py-3 md:py-0 md:pt-6 bg-white/90 dark:bg-gray-900/90 md:bg-transparent md:dark:bg-transparent backdrop-blur-xl md:backdrop-blur-none border-t border-black/10 dark:border-white/10 md:border-black/5 md:dark:border-white/10 shadow-[0_-4px_20px_rgba(0,0,0,0.07)] md:shadow-none">
