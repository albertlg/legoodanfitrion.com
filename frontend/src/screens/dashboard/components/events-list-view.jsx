...
export function EventsListView({
  ...
  return (
    <section className="bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl rounded-3xl border border-black/10 dark:border-white/10 shadow-sm flex flex-col">
      ...
      {/* 1. TOOLBAR: Buscador y Ordenación (PATRÓN UNIFICADO) */}
              ...
              <table className="w-full text-left border-collapse block md:table">
                <thead className="hidden md:table-header-group">
                  <tr>
                    ...
                    <th className="py-4 px-4 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 border-b border-black/5 dark:border-white/10">{t("date")}</th>
                    ...
                    <th className="py-4 px-4 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 border-b border-black/5 dark:border-white/10">RSVP</th>
                  ...
                  {pagedEvents.map((eventItem, index, array) => {
                    ...
                    return (
                      <tr key={eventItem.id} className="block md:table-row flex flex-col mb-4 md:mb-0 p-4 md:p-0 rounded-2xl md:rounded-none border border-black/10 dark:border-white/10 md:border-transparent md:border-b bg-white/40 dark:bg-white/5 md:bg-transparent shadow-sm md:shadow-none transition-colors group">
                        ...
                        <td className="text-sm text-gray-900 dark:text-white align-middle block md:table-cell flex items-center justify-between py-2 md:py-3 px-0 md:px-4 border-b border-black/5 dark:border-white/5 md:border-none last:border-0">
                          <div className="flex flex-col gap-1">
                            <p className="font-bold text-[15px] text-gray-900 dark:text-white">
                              <button className="hover:text-blue-600 dark:hover:text-blue-400 truncate max-w-[200px] sm:max-w-xs text-left transition-colors focus:outline-none" type="button" onClick={() => openEventDetail(eventItem.id)}>
                                {eventItem.title}
                              </button>
                            </p>
                            <p className="text-xs text-gray-500 dark:text-gray-400 font-medium truncate max-w-[200px] sm:max-w-xs">
                        ...
                        {/* Status */}
                        <td className="text-sm text-gray-900 dark:text-white align-middle block md:table-cell flex items-center justify-between py-2 md:py-3 px-0 md:px-4 border-b border-black/5 dark:border-white/5 md:border-none last:border-0">
                          <span className={statusClass(eventItem.status)}>{statusText(t, eventItem.status)}</span>
                        </td>
                        ...
                        {/* Actions */}
                        <td className="align-middle block md:table-cell flex items-center justify-end py-2 md:py-3 px-0 md:px-4 border-b border-black/5 dark:border-white/5 md:border-none last:border-0">
